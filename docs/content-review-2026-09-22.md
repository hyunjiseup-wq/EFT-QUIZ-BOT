...
- 근거를 기록한 문항: 342개(1차 20 + 2차 14 + 3차 19 + 4차 19 + 5차 32 + 6차 28 + 7차 15 + 8차 27 + 9차 14 + 10차 26 + 11차 8 + 12차 19 + 13차 25 + 14차 22 + 15차 35 + 16차 11 + 17차 8).
  그 외 122개를 확인 완료로 표시하지 않는다. 근거가 있는 문항도 충돌·미확인 사항이 남는다.
