...
- 근거를 기록한 문항: 266개(1차 20 + 2차 14 + 3차 19 + 4차 19 + 5차 32 + 6차 28 + 7차 15 + 8차 27 + 9차 14 + 10차 26 + 11차 8 + 12차 19 + 13차 25).
  그 외 198개를 확인 완료로 표시하지 않는다.
- `volatile`: 244개(2차 5개, 4차 2개, 5차 17개, 6차 9개, 7차 1개, 8차 8개, 9차 3개, 11차 1개, 12차 1개 추가). 이 표시는 **출제 제외가 아니다**.
