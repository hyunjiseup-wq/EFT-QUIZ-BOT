...
- 근거를 기록한 문항: 354개(1차 20 + 2차 14 + 3차 19 + 4차 19 + 5차 32 + 6차 28 + 7차 15 + 8차 27 + 9차 14 + 10차 26 + 11차 8 + 12차 19 + 13차 25 + 14차 22 + 15차 35 + 16차 11 + 17차 8 + 18차 12).
  그 외 110개를 확인 완료로 표시하지 않는다. 근거가 있는 문항도 충돌·미확인 사항이 남는다.
- `volatile`: 261개(2차 5개, 4차 2개, 5차 17개, 6차 9개, 7차 1개, 8차 8개, 9차 3개, 11차 1개, 12차 1개, 14차 3개, 15차 4개, 16차 1개, 18차 9개 추가). 이 표시는 **출제 제외가 아니다**.
...
모드별 배치·이벤트 상태의 실측 완료가 아니다. 남은 보스·AI 15문항과 상인 매입 배율
Q225·226 등은 후속 검토 대상으로 유지한다.
