...
class OperationsCheckTests(unittest.TestCase):
    def setUp(self):
        ...
        self.quiz_channel = FakeChannel(self.guild)
        self.supervisor_channel = FakeChannel(self.guild)
        self.bot = FakeBot({20: self.quiz_channel, 30: self.supervisor_channel})
